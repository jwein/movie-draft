export default function MovieCard({ movie, isSelected, onClick, size = 'normal', showTitle = true, disabled = false, disabledReason, yourPick = false }) {
  const sizeClasses = {
    small: 'w-full',
    normal: 'w-full',
    large: 'w-full',
  ...
  return (
    ...
    >
      ...
      {/* Your Pick badge */}
      {yourPick && (
        <div className="absolute top-3 left-3 bg-gold text-charcoal text-[10px] font-semibold px-2 py-1">
          Your Pick
        </div>
      )}
    </button>
